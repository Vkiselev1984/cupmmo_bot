...
Для тестировани административной панели необходимо добавить бота в группу и сделать его администратором, командой /admin запросить права на редактирования. После этого перейти в чат с ботом и отредактировать описание услуг.
